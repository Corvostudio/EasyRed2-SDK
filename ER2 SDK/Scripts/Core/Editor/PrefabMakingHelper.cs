...
public class PrefabMakingHelper : MonoBehaviour
{
    ...
    private static GameObject GenerateBaseRoot(string objectName, UnityEngine.Object modelObject = null)
    {
        ...
        {
            root.transform.position = ((GameObject)modelObject).transform.position;
            GameObject tmpModel = Instantiate((GameObject)modelObject, ((GameObject)modelObject).transform.position, ((GameObject)modelObject).transform.rotation, root.transform);
            tmpModel.AddComponent<MeshCollider>();
        }
        else
        {
    ...
    private static void OnUniformTemplate()
    {
        ...
        ic.materials_fps = new Material[] { null };
    ...
    private static void OnSMGTemplate()
    {
        ...
        smg.fireSound = (AudioClip)AssetDatabase.LoadAssetAtPath("Assets/Corvostudio/Sounds/gun_fire_sounds/thompson_fire.wav", typeof(AudioClip));
        smg.fireSound_distance = (AudioClip)AssetDatabase.LoadAssetAtPath("Assets/Corvostudio/Sounds/distance fire sounds/distantfire_smg-01.wav", typeof(AudioClip));
        smg.fpsAnimations.reload_sound_full = (AudioClip)AssetDatabase.LoadAssetAtPath("Assets/Corvostudio/Sounds/gun_reload_sounds/thompson_eng_reload_full.ogg", typeof(AudioClip));
        smg.fpsAnimations.reload_sound_half = (AudioClip)AssetDatabase.LoadAssetAtPath("Assets/Corvostudio/Sounds/gun_reload_sounds/thompson_eng_reload_partial.ogg", typeof(AudioClip));
    ...
    private static void OnHandGunTemplate()
    {
        ...
        //HG.tpsAnims.fpsAnimSet = FPSAnimationSetID.pistolRun;
        HG.tpsAnims.IKWhenSprinting = false;
        HG.weaponPose = WeaponPose.pistol;
        HG.fireSound = (AudioClip)AssetDatabase.LoadAssetAtPath("Assets/Corvostudio/Sounds/gun_fire_sounds/Col 1911 fire.wav", typeof(AudioClip));
        ...
        HG.fpsAnimations.reload_sound_full = (AudioClip)AssetDatabase.LoadAssetAtPath("Assets/Corvostudio/Sounds/gun_reload_sounds/colt1911_reload_full.ogg", typeof(AudioClip));
        HG.fpsAnimations.reload_sound_half = (AudioClip)AssetDatabase.LoadAssetAtPath("Assets/Corvostudio/Sounds/gun_reload_sounds/colt1911_reload_half.ogg", typeof(AudioClip));
    ...
    private static void OnBoltActionTemplate()
    {
        ...
        gg.fireSound = (AudioClip)AssetDatabase.LoadAssetAtPath("Assets/Corvostudio/Sounds/gun_fire_sounds/kar98_fire.mp3", typeof(AudioClip));
        gg.fireSound_distance = (AudioClip)AssetDatabase.LoadAssetAtPath("Assets/Corvostudio/Sounds/distance fire sounds/distantfire_pistol-01.wav", typeof(AudioClip));
        gg.fpsAnimations.boltaction_sound = (AudioClip)AssetDatabase.LoadAssetAtPath("Assets/Corvostudio/Sounds/gun_reload_sounds/enfield_boltaction.wav", typeof(AudioClip));
        gg.fpsAnimations.chamber_sound_open = (AudioClip)AssetDatabase.LoadAssetAtPath("Assets/Corvostudio/Sounds/gun_reload_sounds/enfield_boltstart.wav", typeof(AudioClip));
        gg.fpsAnimations.chamber_sound = (AudioClip)AssetDatabase.LoadAssetAtPath("Assets/Corvostudio/Sounds/gun_reload_sounds/mosin_reload.ogg", typeof(AudioClip));
        gg.fpsAnimations.chamber_sound_close = (AudioClip)AssetDatabase.LoadAssetAtPath("Assets/Corvostudio/Sounds/gun_reload_sounds/enfield_boltend.wav", typeof(AudioClip));
    ...
    private static void OnMGTemplate()
    {
        ...
        gg.fireSound = (AudioClip)AssetDatabase.LoadAssetAtPath("Assets/Corvostudio/Sounds/gun_fire_sounds/mg42_portable_fire.wav", typeof(AudioClip));
        gg.fireSound_distance = (AudioClip)AssetDatabase.LoadAssetAtPath("Assets/Corvostudio/Sounds/distance fire sounds/distantfire_lmg-01.wav", typeof(AudioClip));
        gg.fpsAnimations.reload_sound_full = (AudioClip)AssetDatabase.LoadAssetAtPath("Assets/Corvostudio/Sounds/gun_reload_sounds/MG42_Mag_Reload.wav", typeof(AudioClip));
        gg.fpsAnimations.reload_sound_half = (AudioClip)AssetDatabase.LoadAssetAtPath("Assets/Corvostudio/Sounds/gun_reload_sounds/MG42_Mag_Reload.wav", typeof(AudioClip));
    ...
    private static void OnPumpActionTemplate()
    {
        ...
        gg.fireSound = (AudioClip)AssetDatabase.LoadAssetAtPath("Assets/Corvostudio/Sounds/gun_fire_sounds/winchester_m12_fire.mp3", typeof(AudioClip));
        gg.fireSound_distance = (AudioClip)AssetDatabase.LoadAssetAtPath("Assets/Corvostudio/Sounds/distance fire sounds/distantfire_shotgun-01.wav", typeof(AudioClip));
        gg.fpsAnimations.boltaction_sound = (AudioClip)AssetDatabase.LoadAssetAtPath("Assets/Corvostudio/Sounds/gun_fire_sounds/winchester_bolt.mp3", typeof(AudioClip));
        gg.fpsAnimations.chamber_sound_open = (AudioClip)AssetDatabase.LoadAssetAtPath("Assets/Corvostudio/Sounds/gun_reload_sounds/winchester_reload_start.wav", typeof(AudioClip));
        gg.fpsAnimations.chamber_sound = (AudioClip)AssetDatabase.LoadAssetAtPath("Assets/Corvostudio/Sounds/gun_fire_sounds/winchester_feed.mp3", typeof(AudioClip));
        gg.fpsAnimations.chamber_sound_close = (AudioClip)AssetDatabase.LoadAssetAtPath("Assets/Corvostudio/Sounds/gun_reload_sounds/winchester_reload_start.wav", typeof(AudioClip));
        gg.fpsAnimations.chamber_sound_close_noAmmo = (AudioClip)AssetDatabase.LoadAssetAtPath("Assets/Corvostudio/Sounds/gun_reload_sounds/winchester_reload_end_pump.wav", typeof(AudioClip));
    ...
    private static void OnRocketLauncheTemplate()
    {
        ...
        gg.fireSound = (AudioClip)AssetDatabase.LoadAssetAtPath("Assets/Corvostudio/Sounds/gun_fire_sounds/panzerfaust_fire.wav", typeof(AudioClip));
        gg.fireSound_distance = (AudioClip)AssetDatabase.LoadAssetAtPath("Assets/Corvostudio/Sounds/gun_fire_sounds/mortar_fire_distant.wav", typeof(AudioClip));
        gg.fpsAnimations.reload_sound_full = (AudioClip)AssetDatabase.LoadAssetAtPath("Assets/Corvostudio/Sounds/gun_reload_sounds/bazooka_reload.ogg", typeof(AudioClip));
    ...
    private static void OnGrenadeTemplate()
    {
        ...
        gg.grenadeSound = (AudioClip)AssetDatabase.LoadAssetAtPath("Assets/Corvostudio/Sounds/grenade_throw_german.ogg", typeof(AudioClip));

        ImpactSoundManager ism = gg.gameObject.AddComponent<ImpactSoundManager>();
        ism.impactSound_generic = (AudioClip)AssetDatabase.LoadAssetAtPath("Assets/Corvostudio/Sounds/object impact/grenade_impact_grass-01.ogg", typeof(AudioClip));
        ism.impactSound_concrete = (AudioClip)AssetDatabase.LoadAssetAtPath("Assets/Corvostudio/Sounds/object impact/grenade_impact_generic-03.ogg", typeof(AudioClip));
    ...
    private static void GenerateMagazine()
    {
        ...
        if (rootGun)
        {
            ...
            else
            {
                ...
                bool isPistol = rootGun.tpsAnims.userController == "CCV2_pistol";
    ...
    private static void OnBuildingTemplate()
    {
        ...
        {
            GameObject building = GenerateBaseRoot(go.name, go);
    ...
    public static void OnWheeledTemplate()
    {
        ...
        SetUpMovableVehicle(mv, out GameObject mufflerSmoke, null, boxes, 8);
        ...
        //Wheels sound
        GameObject wheels_sound = Instantiate((GameObject)AssetDatabase.LoadAssetAtPath("Assets/Corvostudio/Vehicles/TankWheels Sound.prefab", typeof(GameObject)));
        ...
        mv.crashSound = (AudioClip)Instantiate(AssetDatabase.LoadAssetAtPath("Assets/Corvostudio/Sounds/vehicle_crash_1.ogg", typeof(AudioClip)));
    ...
    public static void SetUpMovableVehicle(MovableVehicle vehicle, out GameObject muffleSmoke_root, Sprite icon, BoxCollider[] bxCol, int numberOfSits = 4)
    {
        ...
        //MUFFLER SMOKE
        muffleSmoke_root = Instantiate((GameObject)AssetDatabase.LoadAssetAtPath("Assets/Corvostudio/Shaders/HeatDistorsion/MufflerSmoke.prefab", typeof(GameObject)));
        muffleSmoke_root.transform.SetParent(vehicle.transform);

        //SOUNDS
        //load + assign sounds
        vehicle.engine_start = (AudioClip)AssetDatabase.LoadAssetAtPath("Assets/Corvostudio/Sounds/vehicles/Stuart/M5_Start_Up_Exterior.wav", typeof(AudioClip));
        vehicle.engine_stop = (AudioClip)AssetDatabase.LoadAssetAtPath("Assets/Corvostudio/Sounds/vehicles/Stuart/M5_Turn_Off_Exterior.wav", typeof(AudioClip));
        vehicle.engine_move = (AudioClip)AssetDatabase.LoadAssetAtPath("Assets/Corvostudio/Sounds/vehicles/Stuart/M5_Engine_Loop_Exterior.wav", typeof(AudioClip));
    ...
    public static void OnTanktemplate()
    {
        ...
        SetUpMovableVehicle(mv, out GameObject mufflerSmoke, null, boxes, 3);
        ...
        //tracks sound
        GameObject tracks_sound = Instantiate((GameObject)AssetDatabase.LoadAssetAtPath("Assets/Corvostudio/Vehicles/TankTrucks Sound.prefab", typeof(GameObject)));
    ...
    public static void OnATBoatTemplate()
    {
        ...
        // AUDIO
        mv.engine_start = (AudioClip)AssetDatabase.LoadAssetAtPath("Assets/Corvostudio/Sounds/vehicles/Stuart/M5_Start_Up_Exterior.wav", typeof(AudioClip));
        mv.engine_stop = (AudioClip)AssetDatabase.LoadAssetAtPath("Assets/Corvostudio/Sounds/vehicles/Stuart/M5_Turn_Off_Exterior.wav", typeof(AudioClip));
        mv.engine_move = (AudioClip)AssetDatabase.LoadAssetAtPath("Assets/Corvostudio/Sounds/vehicles/Stuart/M5_Engine_Loop_Exterior.wav", typeof(AudioClip));

        //Particle Sys
        GameObject ms = Instantiate((GameObject)AssetDatabase.LoadAssetAtPath("Assets/LCVP water FX.prefab", typeof(GameObject)));
    ...
    public static void OnPlaneTemplate()
    {
        ...
        mv.engine_start = (AudioClip)AssetDatabase.LoadAssetAtPath("Assets/Corvostudio/Sounds/planes/stuka_engine_STARTUP.ogg", typeof(AudioClip));
        mv.engine_move = (AudioClip)AssetDatabase.LoadAssetAtPath("Assets/Corvostudio/Sounds/planes/stuka_engine_MOVING.ogg", typeof(AudioClip));
        mv.engine_stop = (AudioClip)AssetDatabase.LoadAssetAtPath("Assets/Corvostudio/Sounds/vehicles/german_tank_stop.wav", typeof(AudioClip));
        mv.engine_move_far = (AudioClip)AssetDatabase.LoadAssetAtPath("Assets/Corvostudio/Sounds/vehicles/Additional/Aircraft_Idle_far.wav", typeof(AudioClip));
    ...
    public static void SetUpDetachablePropellers()
    {
        ...
        foreach (GameObject go in Selection.gameObjects)
        {
            if (go != null && IsInstance(go) && !go.GetComponentInParent<VehicleDamagableDetachablePart>())
            {
                ...
                GameObject blur = new GameObject("Propeller blur here");// (GameObject)Instantiate(AssetDatabase.LoadAssetAtPath("Assets/ER2 SDK/Prefabs/PropellerFastBlur_pivot.prefab", typeof(GameObject)));
    ...
    private static void AddGunToTurret(TurretGun turret)
    {
        ...
        newWeapon.fireSound = (AudioClip)AssetDatabase.LoadAssetAtPath("Assets/Corvostudio/Sounds/vehicles/Cannon fire/70mm_fire.ogg", typeof(AudioClip));
    ...
    private static void AddMgToTurret(TurretGun turret)
    {
        ...
        ammos[0].start_ammo_count = 300;
        newWeapon.ammos = ammos;
        newWeapon.specifiedTracersRatio = 3;

        //Setting up sounds for turret
        newWeapon.fireSound = (AudioClip)AssetDatabase.LoadAssetAtPath("Assets/Corvostudio/Sounds/gun_fire_sounds/30cal_fire.ogg", typeof(AudioClip));
        newWeapon.fireSound_distance = (AudioClip)AssetDatabase.LoadAssetAtPath("Assets/Corvostudio/Sounds/distance fire sounds/distant_mg-01.wav", typeof(AudioClip));
